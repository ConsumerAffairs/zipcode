...
class Zip(object):
    ...
    def __init__(self, zip_tuple):
        ...
        """
        The type of zip code according to USPS:
        'UNIQUE', 'PO BOX', or 'STANDARD'
        """
        ...
        """
        This value will always be 'Primary'.
        Secondary and 'Not Acceptable' placenames have been removed.
        """
        self.lat = zip_tuple[_LAT]
        """
        The latitude associated with the zipcode according to the National
        Weather Service. This can be empty when there is no NWS Data
        """
        self.lon = zip_tuple[_LONG]
        """
        The longitude associated with the zipcode according to the National
        Weather Service. This can be empty when there is no NWS Data
        """
        ...
        """
        This value will always be US for United States -- This includes
        Embassy's, Military Bases, and Territories
        """
        self.location_text = zip_tuple[_LOCATION_TEXT]
        """
        The city with its state or territory.
        Example: 'Cleveland, OH' or 'Anasco, PR'
        """
        self.location = zip_tuple[_LOCATION]
        """
        A string formatted as WORLD_REGION-COUNTRY-STATE-CITY.
        Example: 'NA-US-PR-ANASCO'
        """
